...
public:
	...
	void ChangeTextColor(TextColors InColor, bool isForeGround, std::function<void()> func);
	void ResetTextColor();
	void ClearCmd();
	void PrintTopLine();
	void PrintBottomLine();
	void PrintVerticalLeftLine();
	void PrintVerticalRightLine();
	void PrintFrame();
	void PrintVerticalLine(__int32 InX);
	void PrintVerticalLine(__int32 InX, __int32 InStartY, __int32 InEndY);
	void PrintHorizontalLine(__int32 InStartX, __int32 InEndX, __int32 InY);
